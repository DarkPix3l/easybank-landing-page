...
function HeaderDesktop() {
  return (
    <header className="w-full h-[100px] fixed bg-white z-[3] shadow-[0_-17px_28px_4px_#9698a6]">
      <div className="headerWrapper flex flex-row justify-between items-center h-full wrapper">
        <img
          src="./images/logo.svg"
          alt="Easybank logo"
        />
